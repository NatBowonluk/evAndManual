...
const unsigned long eventIntervalEV = 500;
...
float evGetTemp() {
  ...
  float evTemp = ((temprature_sens_read() - 32) / 1.8)  -13;
...
void evLogic(uint8_t lastVehicleStatus, uint8_t VehicleStatus) {
  ...
  //  debug("startChargeHR : "); debugln(currentValue.startChargeHR);
  //  debug("startChargeMN : "); debugln(currentValue.startChargeMN);
  //  debug("startChargeSS : "); debugln(currentValue.startChargeSS);
  //  debug("NstartChargeHR : "); debugln(evv.timeChargingHH);
  //  debug("NstartChargeMN : "); debugln(evv.timeChargingMM);
  //  debug("NstartChargeSS : "); debugln(evv.timeChargingSS);
...
void evRunning() {
  ...
  //  if (currentTimeEV - previousTimeEV >= eventIntervalEV) {
  if (itIsTime(currentTimeEV, previousTimeEV, eventIntervalEV)) {
    //    debugln("///////////////////////////////////////////////////////////////////////////////");
    //    debug("Now : "); debugln(evCarGetStat());
    //    debug("Old : "); debugln(evlastStat);
    //    debugln("///////////////////////////////////////////////////////////////////////////////");
    //    debug("mode"); debugln(currentValue.isStartOrFinish);
    //    printf("////////////////////////////////////////////////////\n");
    //    printf("errorout : %d, errorin : %d\n", evEmergengy(), evErrorEZero());
    //    printf("////////////////////////////////////////////////////\n");

    if (!simulateCar) {
      //      debug("config.firstSleepThisDay : "); debugln(config.firstSleepThisDay);
      //      debug("config.currentDate : "); debugln(config.currentDate);
      ...
      evLogic(evlastStat, simulateCarValue);
    }
